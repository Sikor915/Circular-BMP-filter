...
int main(int argc, char *argv[])
{
	...
	//			auto CompressionFuncReal = (MyFunctionType3)GetProcAddress(hLibASM, "CompressionFuncCircus");
	...
	//						{
	//							CompressionFuncReal(&rgbDataSegments[currentIdx], segmentSize, width, segmentHeight);
	//						});
	...
	//					threads.emplace_back([&rgbDataSegments, currentIdx, segmentSize, width, segmentHeight, CompressionFuncCircus]()
	//						{
	//							CompressionFuncCircus(&rgbDataSegments[currentIdx], segmentSize, width, segmentHeight);
	//						});
